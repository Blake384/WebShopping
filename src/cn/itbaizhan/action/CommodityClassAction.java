...
public class CommodityClassAction extends ActionSupport {
	...
	public String updateCommodityClass(){
		...
		ActionContext.getContext().put("message", commodityClass.getCommodityClassName()+"updated successfully");
	...
	public String addCommodityClass(){
		...
		ActionContext.getContext().put("message", commodityClass.getCommodityClassName()+"added successfully");
		}
		else ActionContext.getContext().put("message", "该商品种类："+commodityClass.getCommodityClassName()+"already exists. Please re-enter the information!");
		return "addCommodityClass";
	}
