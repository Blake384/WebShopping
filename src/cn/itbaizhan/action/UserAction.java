...
public class UserAction extends ActionSupport {
	...
	public String updateUser(){
		...
		ActionContext.getContext().put("updatemessage", "Your information has been updated!");
		return "updateUser";
	}
	public String updateUser1(){
		...
		this.service.update(user);
		System.out.println("user:"+user.getUserId());
		ActionContext.getContext().put("addComessage", "Your information has been updated!");
		return "queryUser";
	}
	@SuppressWarnings("unchecked")
	...
	*/
	public String findUser()
	{
		...
		if(user==null){
			ActionContext.getContext().put("findUsernull", "No user information found!");
			return "findUsernull";
		}else{
	...
	public String upPass()
	{
		this.service.update(user);
		System.out.println("user:"+user.getUserId());
		ActionContext.getContext().put("upPass", "Your password has been changed!");
		return "upPass";
	}
	//重设密码
	public String updatePass()
	{
		this.service.update(user);
		System.out.println("user:"+user.getUserId());
		ActionContext.getContext().put("updatePass", "Your password has been updated!");
		return "updatePass";
	}
	//用户注册验证
	public String register()
	{
		...
		if(user == null){
			ActionContext.getContext().put("regmessage", username+"is available for registration");
			return "regsuccess";
		}else{
			ActionContext.getContext().put("regmessage", username+"is already registered");
			return "regerror";
		}
	}
	//用户登录
	public String login(){
		...
		if(user == null){
			ActionContext.getContext().put("message", "Incorrect username or password");		
			return "login";
		}else{
