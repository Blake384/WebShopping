...
public class CommodityAction extends ActionSupport {
	...
	public String updateCommodity() {
		...
		if (fileName==null){
			...
			try {
				...
				ActionContext.getContext().put("addComessage", "Image upload failed!");
		...
		ActionContext.getContext().put("addComessage", commodity.getCommodityName()+"updated successfully");
	...
	public String addCommodity(){
		...
		System.out.println("commodity:"+commodity.getCommodityName());
		ActionContext.getContext().put("addComessage", commodity.getCommodityName()+"added successfully");	
		}
		else {
			ActionContext.getContext().put("addComessage", commodity.getCommodityName()+"already exists. Please re-enter commodity information!");
		}
