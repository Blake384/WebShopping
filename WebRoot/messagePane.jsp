   ...
   <div id="main_content"> 
            ...
            <div class="left_menu_corner"></div>
                    <ul class="menu">
                         ...
                         <li class="divider"></li>
                         <li><a href="index.jsp" class="nav2">Online Shopping</a></li>
                         <li class="divider"></li>
    ...
    Navigation: <span class="current"><a href="index.jsp">Home</a>&gt;&gt;User Messages</span>
...
<input name="Search" type="submit" value="Search" />
    ...
    <tr><td  align=center> <h3>Sorry, not logged in. Please log in.</h3>
   ...
   <% response.setHeader("refresh","3;url=login.jsp");%> 
    ...
    <table><tr><td colspan=2 align=center height=40><h3>Your message has been submitted!</h3></td></tr>
    <tr><td><input type="button" value="Return to Message Board" style="height:30px;width:100px" onclick="window.location.href('message.jsp')"/></td>
    <td><input type="button" value="View Message Board" style="height:30px;width:100px" onclick="window.location.href('messageShow.jsp')"/></td></tr>
    </table>
	</td>
