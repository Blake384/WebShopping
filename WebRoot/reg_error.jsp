...
document.write(strDate);
   ...
   <table>
    <tr>
    <td align="center"><h2>Username already exists, please re-enter registration information</h2></td>
    
    </tr>
    <tr><td align=center height=30><h3>Returning to the registration page! If not redirected, <a href=register.jsp>click here</a></h3></td>
     </tr>
    </table>
