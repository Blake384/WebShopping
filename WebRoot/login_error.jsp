	...
	<div id="header">
	 ...
	 <div id="divstr"><br/><h2>Welcome to the Online Mall</h2><h3><script language=JavaScript>
        ...
        switch (n_day) {
            ...
            default: { daysOfWeek = "Sunday"; } break;
        }
...
<table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" height="400px" bgcolor="#e9e7e7">
    <tr>
        ...
        <td class="center_content" width="100%" height="400px" align="center">
            <table>
                <tr>
                    <td align="center"><h2>Sorry, incorrect username or password!</h2></td>
                </tr>
                <tr>
                    <td align="center" height="30"><h3>Redirecting to the login page! If you are not redirected, <a href="login.jsp">click here</a></h3></td>
                </tr>
            </table>
