...
<form name="form1" action="CommodityClassAction!addCommodityClass.action" method="post" onsubmit="return check();">
    <TABLE cellSpacing="1" cellPadding="3" width="95%" align="center" bgColor="#6ab6b6" border="0">
        <TBODY>
            <TR>
                <TH colSpan="2" height="24">【Add New Product Category】</TH>
            </TR>
            <TR>
                <TD class="forumrow" width="30%" height="24">
                    <div align="right">Category Name:</div>
                </TD>
                <TD class="forumrowhighlight" width="70%" height="24">
                    <input type="text" name="commodityClass.commodityClassName" id="name">
                </TD>
            </TR>
            <TR>
            ...
            <TR>
                <TD align="center" colSpan="2" height="24" class="forumrow">
