...
<TABLE cellSpacing=0 cellPadding=0 width=1004 border=0 align="center">
  <TBODY>
    <TR>
      <TD colSpan=6><IMG height=92 alt="" src="images/crm_1.gif" width=345></TD>
      <TD colSpan=4><IMG height=92 alt="" src="images/crm_2.gif" width=452></TD>
      <TD><IMG height=92 alt="" src="images/crm_3.gif" width=207></TD>
    </TR>
    <TR>
      <TD colSpan=6><IMG height=98 alt="" src="images/crm_4.gif" width=345></TD>
      <TD colSpan=4><IMG height=98 alt="" src="images/crm_5.gif" width=452></TD>
      <TD><IMG height=98 alt="" src="images/crm_6.gif" width=207></TD>
    </TR>
    <TR>
      <TD rowSpan=5><IMG height=370 alt="" src="images/crm_7.gif" width=59></TD>
      <TD colSpan=5><IMG height=80 alt="" src="images/crm_8_1.gif" width=286></TD>
      <TD colSpan=4><IMG height=80 alt="" src="images/crm_9.gif" width=452></TD>
    ...
    <TR>
                ...
                <TABLE id=table2 cellSpacing=1 cellPadding=0 width="100%" border=0>
                  <TBODY>
                    <TR>
                      ...
                      <TD><INPUT class=regtxt title="Please enter username" maxLength=16 size=16 name="admin.username" id="username"></TD>
                    </TR>
                    <TR>
                      <TD align=middle width=81><FONT color=#ffffff>Password:</FONT></TD>
                      <TD><INPUT class=regtxt title="Please enter password" type=password maxLength=16 size=16 name="admin.password" id="password"></TD>
                    </TR>
                  </TBODY>
                </TABLE>
              </TD>
      ...
      <TD colSpan=2 rowSpan=2><IMG height=158 alt="" src="images/crm_13.gif" width=295></TD>
      <TD rowSpan=2><IMG height=158 alt="" src="images/crm_14.gif" width=207></TD>
    </TR>
    <TR>
      <TD rowSpan=3><IMG height=180 alt="" src="images/crm_15.gif" width=127></TD>
      <TD rowSpan=3><IMG height=180 alt="" src="images/crm_16.gif" width=24></TD>
      <TD><INPUT title="Login to Admin Panel" type=image height=48 alt="Login to Admin Panel" width=86 src="images/crm_17.gif" name="image" onclick="this.form.submit()"/></TD>
      <TD><IMG height=48 alt="" src="images/crm_18.gif" width=21></TD>
      <TD colSpan=2><A href="../GoIndexAction.action"><IMG title="Return to Homepage" height=48 alt="Return to Homepage" src="images/crm_19.gif" width=84 border=0></A></TD>
    ...
    <TR>
      ...
      <TD rowSpan=2><IMG height=132 alt="" src="images/crm_22.gif" width=170></TD>
      <TD colSpan=2><IMG height=75 alt="" src="images/crm_23.gif" width=332></TD>
    </TR>
    <TR>
      <TD colSpan=2><IMG height=57 alt="" src="images/crm_24.gif" width=332></TD>
    </TR>
    <TR>
