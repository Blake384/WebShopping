...
<HTML>
<HEAD>
<TITLE>Online Mall System Backend Management</TITLE>
...
<BODY style="MARGIN: 0px">
				...
				<DIV class=menu>
					<UL>
						...
						<LI id=menu_2 onmouseover=Menus.Show(this,0)
							onclick=getleftbar(this);><A href="#">Order Management</A>
							<DIV class=menu_childs onmouseout=Menus.Hide(0);>
								<UL>
									<LI><A href="OrderFormAction!listOrderForm.action"
										target=frmright>Order List</A></LI>
								</UL>
							</DIV>
							<DIV class=menu_div>
								<IMG style="VERTICAL-ALIGN: bottom"
						...
						<LI id=menu_3 onmouseover=Menus.Show(this,0)
							onclick=getleftbar(this);><A href="#">User Management</A>
							<DIV class=menu_childs onmouseout=Menus.Hide(0);>
								<UL>
									<LI><A href="UserAction!listUser.action" target=frmright>User List</A>
									</LI>
									<LI><A href="include/user/userQuery.jsp" target=frmright>User Query</A>
									</LI>
								</UL>
							</DIV>
						...
						<LI id=menu_4 onmouseover=Menus.Show(this,0)
							onclick=getleftbar(this);><A href="#">System Management</A>
							<DIV class=menu_childs onmouseout=Menus.Hide(0);>
								<UL>
									<LI><A href="include/admin/amend.jsp" target=frmright>Change Login Password</A>
									</LI>
								</UL>
							</DIV>
							<DIV class=menu_div>
					...
					<TD class=main_left id=frmTitle vAlign=top align=center>
						<TABLE class=main_left_top cellSpacing=0 cellPadding=0
							...
							<TBODY>
								<TR height=32>
									<TD vAlign=top></TD>
									<TD class=main_left_title id=leftmenu_title>Common Shortcuts</TD>
						...
						<TABLE cellSpacing=0 cellPadding=0 width="100%" bgColor=#c4d8ed
							...
							<TBODY>
								<TR height=32>
									...
									<TD background=images/bg2.gif><SPAN style="FLOAT: left">Online Mall System Backend Management</SPAN>
										<SPAN id=dvbbsannounce
										style="FONT-WEIGHT: bold; FLOAT: left; WIDTH: 80%; COLOR: #c00">
									</SPAN></TD>
									<TD style="COLOR: #135294; TEXT-ALIGN: right"
										background=images/bg2.gif>Welcome：${sessionScope.admin.username}|
										<A href="login.jsp">Backend Home</A> | <A href="../GoIndexAction.action"
										target=_top>Home</A> | <A href="AdminAction!logout.action"
										onclick="return confirm('确定要退出吗?')" target=_top>Logout </A>
									</TD>
	...
	<c:if test="${empty sessionScope.admin.username}">
		...
		<table width=100% height=80% align=center bgColor="#c0c0c0">
			<tr>
				<td align="center">
					<h3>Sorry, not logged in yet, please log in</h3>
					<h3>
						Redirected to login page, if not please<a href=login.jsp>Click here!</a>
					</h3>
				</td>
			</tr>
		</table>
